...
def detect_vehicles_and_crop(image_path, models, device):
...
def process_folder(input_folder, output_folder, retain_uncropped = False):
    ...
    if retain_uncropped:
        real_seeded_image_folder = output_folder.split('/')[0] + '/datasets/real_seeded/images'
    ...
    for image_file in tqdm(sorted(os.listdir(input_folder))):
        ...
        if image_file.lower().endswith(('.png', '.jpg', '.jpeg')):
            ...
            images = detect_vehicles_and_crop(image_path, models, device)
